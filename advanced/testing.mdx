...
description: "Inject a fake PSR-18 HTTP client into the PHP AI SDK to unit test your Claude integrations without making real Anthropic API calls or incurring costs."
---
