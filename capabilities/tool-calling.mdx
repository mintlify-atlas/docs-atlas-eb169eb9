---
title: "Tool Calling with Claude in the PHP AI SDK"
sidebarTitle: "Tool Calling"
description: "Define tools with input schemas and let Claude invoke them during generation. The Anthropic provider converts PHP Tool objects to Anthropic's tool-use format automatically."
---
...
Pass multiple tools at once using `->tools()` with a comma-separated list or an array:
