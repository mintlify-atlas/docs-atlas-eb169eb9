---
title: "Stream Claude Responses Chunk by Chunk in PHP"
sidebarTitle: "Streaming"
description: "Stream Claude model responses using server-sent events. Iterate over text chunks in real time and access the final result after the stream completes."
---
