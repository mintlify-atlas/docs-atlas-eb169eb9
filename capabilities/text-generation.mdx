---
title: "Text Generation with Claude Models in the PHP AI SDK"
sidebarTitle: "Text Generation"
description: "Generate text with Claude models in PHP: pass system instructions, build multi-turn message history, and read token usage from the response."
---
