---
title: "Structured Output from Claude via Forced Tool Use"
sidebarTitle: "Structured Output"
description: "Extract typed JSON objects from Claude responses. The Anthropic provider adapts structured output using a forced tool-use strategy since Claude lacks native JSON schema support."
---
